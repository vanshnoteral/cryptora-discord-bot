    ...
    <section className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-orbitron font-bold text-gradient mb-6" data-testid="features-title">
            Features
          </h2>
          ...
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className={`text-2xl sm:text-3xl font-orbitron font-bold ${feature.color} mb-4`}>
                  {feature.title}
                </h3>
